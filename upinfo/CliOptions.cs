    ...
    public class CliOptions
    {
        public CliOptions(IEnumerable<string> args)
        {
            ...
            _optionSet = new OptionSet
            {
                ...
                {"u|upOnly", "print up time only", v=> ShowOnTimeOnly = v != null},
        ...
        public bool ShowOnTimeOnly   { get; private set; }
        ...
        public void WriteUsage(TextWriter writer)
        {
            ...
            writer.WriteLine(" upinfo [options]");
            writer.WriteLine();
